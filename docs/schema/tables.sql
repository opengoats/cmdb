...
CREATE TABLE IF NOT EXISTS `resource` (
  `id` char(64) NOT NULL COMMENT '对象Id',
  `status` smallint Not NULL COMMENT '0:删除,1:创建,2:更新',
  `create_at` bigint(13) NOT NULL COMMENT '创建时间(13位时间戳)',
  `create_by` varchar(255)  DEFAULT '' COMMENT '创建人',
  `update_at` bigint(13) DEFAULT 0 COMMENT '更新时间',
  `update_by` varchar(255) DEFAULT '' COMMENT '更新人',
  `delete_at` bigint(13) DEFAULT 0 COMMENT '删除时间',
  `delete_by` varchar(255) DEFAULT '' COMMENT '删除人',
  `c_id` char(64) NOT NULL COMMENT '云商自己的Id',
  ...
  `c_status` varchar(255) NOT NULL COMMENT '服务商中的状态',
  ...
  KEY `idx_c_status` (`c_status`) USING BTREE,
